  ...
  return (
    <main className="overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:grid lg:grid-cols-12 lg:gap-12 lg:items-center">
            <div className="text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
              ...
              <h1 className="text-3xl font-bold text-gray-900 tracking-tight sm:text-4xl md:text-5xl lg:text-6xl leading-tight">
                Make Your LLM APIs
                <span className="block text-orange-500">Faster. Cheaper.</span>
                <span className="block">Automatically.</span>
              </h1>
              <p className="mt-4 sm:mt-5 text-base text-gray-500 sm:text-lg lg:text-xl max-w-xl lg:mx-0 mx-auto">
              ...
              <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
                <Link href="/sign-up" className="w-full sm:w-auto">
                  <Button size="lg" className="w-full sm:w-auto rounded-full text-base px-6 bg-orange-500 hover:bg-orange-600 text-white">
                    Start Free
                    <ArrowRight className="ml-2 h-4 w-4" />
                  </Button>
                </Link>
                <Link href="/benchmarks" className="w-full sm:w-auto">
                  <Button size="lg" variant="outline" className="w-full sm:w-auto rounded-full text-base px-6">
                    View Benchmarks
                  </Button>
                </Link>
              </div>
            ...
            <div className="mt-10 sm:mt-14 lg:mt-0 lg:col-span-6">
              <Terminal />
            </div>
          </div>
        </div>
      ...
      <section className="py-10 sm:py-14 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-center text-xs font-semibold uppercase tracking-widest text-gray-500 mb-8 sm:mb-10">
            Real benchmark results, measured not estimated
          </p>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 text-center">
            {BENCHMARKS.map(b => (
              <div key={b.label}>
                <div className="text-3xl sm:text-4xl font-bold text-orange-500">{b.result}</div>
                <div className="text-xs sm:text-sm text-gray-300 font-medium mt-1">{b.unit}</div>
      ...
      <section className="py-14 sm:py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3 sm:mb-4">One gateway. Every provider.</h2>
          <p className="text-gray-500 mb-8 sm:mb-12 text-base sm:text-lg">All optimisations apply regardless of which LLM sits behind the gateway.</p>
          <div className="bg-gray-950 rounded-2xl p-4 sm:p-6 lg:p-8 font-mono text-xs sm:text-sm text-left overflow-x-auto border border-gray-800">
...
Haiku/Opus     4o/mini       Pro/Flash`}</pre>
      ...
      <section className="py-14 sm:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 sm:mb-14">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">Connect. Optimise. Save.</h2>
            <p className="text-gray-500 mt-3 text-base sm:text-lg">No rewrite required. Works with any OpenAI-compatible client.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {HOW_IT_WORKS.map(h => (
              <div key={h.step}>
                <div className="text-4xl sm:text-5xl font-black text-orange-100 mb-3">{h.step}</div>
      ...
      <section className="py-14 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 sm:mb-14">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">13 optimisations. Zero config.</h2>
            <p className="text-gray-500 mt-3 text-base sm:text-lg">Every request passes through the full stack automatically.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            {FEATURES.map(f => (
              <div key={f.title} className="group p-4 sm:p-6 rounded-2xl border border-gray-100 hover:border-orange-200 hover:shadow-sm transition-all">
      ...
      <section className="py-14 sm:py-20 bg-gray-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4">How much are you wasting?</h2>
          <p className="text-gray-400 mb-8 sm:mb-10 text-base sm:text-lg">Enter your current spend. We&apos;ll show you what we&apos;d save.</p>
          <SavingsCalcClient />
        </div>
      </section>
      ...
      <section className="py-14 sm:py-20 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-500 text-base sm:text-lg mb-7 sm:mb-8">
            Optimise your inference. The savings are real and measurable from request one.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link href="/sign-up" className="w-full sm:w-auto">
              <Button size="lg" className="w-full sm:w-auto rounded-full text-base px-8 bg-orange-500 hover:bg-orange-600 text-white">
                Start Optimising Free
                <ArrowRight className="ml-2 h-4 w-4" />
              </Button>
            </Link>
            <Link href="/pricing" className="w-full sm:w-auto">
              <Button size="lg" variant="outline" className="w-full sm:w-auto rounded-full text-base px-8">
                See Pricing
              </Button>
            </Link>
          </div>
