...
export default function SavingsCalcClient() {
  ...
  return (
    <div className="bg-gray-800 rounded-2xl p-4 sm:p-6 text-left max-w-2xl mx-auto border border-gray-700">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="10,000"
              className="w-full bg-gray-900 border border-gray-700 rounded-lg pl-7 pr-3 py-3 text-white text-sm focus:outline-none focus:border-orange-500 placeholder:text-gray-600"
            />
          </div>
        </div>
        <div>
          ...
          <input
            ...
            className="w-full bg-gray-900 border border-gray-700 rounded-lg px-3 py-3 text-white text-sm focus:outline-none focus:border-orange-500 placeholder:text-gray-600"
          />
        </div>
        <div>
          ...
          <select
            ...
            className="w-full bg-gray-900 border border-gray-700 rounded-lg px-3 py-3 text-white text-sm focus:outline-none focus:border-orange-500"
          >
      ...
      {monthlySpend > 0 ? (
        <div className="bg-gray-900 rounded-xl p-4 sm:p-5 border border-gray-700">
          <p className="text-xs text-gray-500 uppercase tracking-wide font-semibold mb-4">Estimated optimisation</p>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 text-center">
            <div className="bg-gray-800 sm:bg-transparent rounded-lg p-3 sm:p-0">
        ...
        <div className="bg-gray-900 rounded-xl p-4 sm:p-5 border border-gray-700 text-center text-gray-500 text-sm">
